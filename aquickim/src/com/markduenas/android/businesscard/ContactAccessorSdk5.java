...
public class ContactAccessorSdk5 extends ContactAccessor {
    ...
    public ContactInfo loadContact(ContentResolver contentResolver, Uri contactUri) {
        ...
        // Load the display name for the specified person, where CONTENT_TYPE is TYPE_MOBILE
        Cursor cursor = contentResolver.query(contactUri,
                new String[]{Contacts._ID, Contacts.DISPLAY_NAME}, Contacts.HAS_PHONE_NUMBER + "=1", null, null);
        try {
        ...
        cursor = contentResolver.query(Phone.CONTENT_URI,
                	...
                	Phone.CONTACT_ID + "=" + contactId + " AND " + Phone.TYPE + "=" + Phone.TYPE_MOBILE, 
                	null, 
